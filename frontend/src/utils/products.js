...
export const SliderData = [
  {
      id: 1,
      title: "Run your multichannel ecommerce",
      desc: "manage your products and channels from a single centralized platform.",
      cover: sofaSlide,
  },
  {
      id: 2,
  ...
  {
      id: 4,
      title: "Run your multichannel ecommerce from single platform",
      desc: "manage your products and channels from a single centralized platform.",
      cover: watchSlide,
  },
];
...
export const serviceData = [
  {
    ...
    subtitle: "List your Product to multiple channel",
    bg: "#fdefe6",
  },
  {
    icon: <ion-icon name="card"></ion-icon>,
    title: "Order Listing",
    subtitle: "Manage your Order to multiple Channel",
    bg: "#ceebe9",
  },
  {
    icon: <ion-icon name="shield-half-outline"></ion-icon>,
    title: "Inventory Listing",
    subtitle: "List your Inventory to multiple channel",
    bg: "#e2f2b2",
  },
  {
    icon: <ion-icon name="headset"></ion-icon>,
    title: "Price Listing",
    subtitle: "List your Price to multiple channel.",
    bg: "#d6e5fb",
  },
];
